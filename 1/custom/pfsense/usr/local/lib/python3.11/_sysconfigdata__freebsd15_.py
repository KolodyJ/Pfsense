...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'cc -pthread -shared -L/usr/local/lib  -fstack-protector-strong',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'amd64-portbld-freebsd15.0',
 'BYTESTR_DEPS': '\\',
 'CC': 'cc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 -pipe  '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-flto -std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_LDFLAGS_NODIST': '-flto',
 'CONFIGURE_LDFLAGS_NOLTO': '-flto=thin',
 'CONFIG_ARGS': "'--enable-shared' '--without-ensurepip' '--with-system-ffi' "
                "'--without-pydebug' '--enable-ipv6' '--with-system-libmpdec' "
                "'--with-lto' '--with-pymalloc' '--prefix=/usr/local' "
                "'--localstatedir=/var' '--mandir=/usr/local/share/man' "
                "'--infodir=/usr/local/share/info/' "
                "'--build=amd64-portbld-freebsd15.0' "
                "'build_alias=amd64-portbld-freebsd15.0' 'PKG_CONFIG=pkgconf' "
                "'PKG_CONFIG_LIBDIR=/wrkdirs/usr/ports/lang/python311/work/.pkgconfig:/usr/local/libdata/pkgconfig:/usr/local/share/pkgconfig:/usr/libdata/pkgconfig' "
                "'CC=cc' 'CFLAGS=-O2 -pipe  -fstack-protector-strong "
                "-fno-strict-aliasing ' 'LDFLAGS= -L/usr/local/lib  "
                "-fstack-protector-strong ' 'LIBS=-L/usr/local/lib -lintl' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/usr/local/include -I/usr/local/include',
 'CXX': 'c++ -pthread',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'amd64-portbld-freebsd15.0',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -O2 -pipe  -fstack-protector-strong '
                    '-fno-strict-aliasing -flto -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                    '-I/usr/local/include -I/usr/local/include -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/usr/local/include',
 'LIBM': '-lm',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-Wunreachable-code -DNDEBUG -O2 -pipe  '
                    '-fstack-protector-strong -fno-strict-aliasing -flto '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/libdata/pkgconfig',
 ...
 'LIBS': '-lintl -ldl -L/usr/local/lib -lintl -lutil',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'cc -pthread',
 ...
 'MODDISABLED_NAMES': '_sqlite3  _tkinter  _gdbm  nis',
 'MODLIBS': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 '
 ...
 'PY_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 -pipe  '
              '-fstack-protector-strong -fno-strict-aliasing',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 -pipe  '
                   '-fstack-protector-strong -fno-strict-aliasing -flto '
                   '-std=c11 -Wextra -Wno-unused-parameter '
                   '-Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I./Include/internal -I. -I./Include -I/usr/local/include '
                   '-I/usr/local/include -fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/usr/local/lib  -fstack-protector-strong -flto',
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/local/include -I/usr/local/include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/usr/local/lib  -fstack-protector-strong',
 'PY_LDFLAGS_NODIST': '-flto',
 'PY_LDFLAGS_NOLTO': '-L/usr/local/lib  -fstack-protector-strong -flto=thin',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
 'PY_SQLITE_HAVE_SERIALIZE': 0,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -O2 -pipe  '
                        '-fstack-protector-strong -fno-strict-aliasing -flto '
                        '-std=c11 -Wextra -Wno-unused-parameter '
                        '-Wno-missing-field-initializers '
                        '-Werror=implicit-function-declaration '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9',
 'SCRIPTDIR': '/usr/local/lib',
 'SETPGRP_HAVE_ARG': 1,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lintl -ldl -L/usr/local/lib -lintl -lutil',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9 '
 ...
 'abs_builddir': '/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9',
 'abs_srcdir': '/wrkdirs/usr/ports/lang/python311/work/Python-3.11.9',
